...
rule autogen_peexe_ObfuscatedGreywareOverlayPackedShell32dll_7efd1055
{
	meta:
		author = "FileScan.IO Engine v1.1.0-10434c5"
		date = "2023-03-11"
		sample = "7efd1055ea05a8fb0e8dab395b68017720d468d3ffb3ef3baeb501f809528827"
		score = 50
		tags = "obfuscated,greyware,overlay,packed,shell32.dll"
		isWeakRule = false
	...
	strings:
		...
		//IOC patterns
		$req0 = "\"http://crl.trustwave.com/TWGCA.crl0n"
		$req1 = "$Lua: Lua 5.1.4 Copyright (C) 1994-2008 Lua.org, PUC-Rio $\n$Authors: R. Ierusalimschy, L. H. de Figueiredo & W. Celes $\n$URL: ww"
		$req2 = "$http://crl.vikingcloud.com/TWGCA.crl0t"
		$req3 = ")http://crl.securetrust.com/TWGCSCA_L1.crl0y"
		$req4 = "*http://ssl.trustwave.com/issuers/TWGCA.crt0"
		$req5 = "+http://crl.vikingcloud.com/VCTWGTSCA_L1.crl0{"
		$req6 = ".http://certs.securetrust.com/issuers/TWGCA.crt0"
		$req7 = "/http://crt.comodoca.com/COMODORSAAddTrustCA.crt0$"
		$req8 = "1994-2015 Lua.org, PUC-Rio."
		$req9 = "1http://crl.usertrust.com/UTN-USERFirst-Object.crl05"
		$req10 = "2019 Indigo Rose Corporation (www.indigorose.com)"
		$req11 = "2http://crl.comodoca.com/COMODORSACodeSigningCA.crl0t"
		$req12 = "2http://crt.comodoca.com/COMODORSACodeSigningCA.crt0$"
		$req13 = "3http://certs.securetrust.com/issuers/TWGCSCA_L1.crt0"
		$req14 = "5http://certs.securetrust.com/issuers/VCTWGTSCA_L1.crt0"
		$req15 = ";http://crl.comodoca.com/COMODORSACertificationAuthority.crl0q"
		$req16 = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?> \r\n<assembly xmlns=\"urn:schemas-microsoft-com:asm.v1\" manifestVersion=\"1."
		$req17 = "<supportedOS Id=\"{35138b9a-5d96-4fbd-8e2d-a2440225f93a}\"/>\r\n\t\t\t<!-- Windows 8 Support -->\r\n\t\t\t\t<supportedOS Id=\"{4a2f28e3-53b9-4"
		$req18 = "http://ocsp.securetrust.com/0?"
		$req19 = "http://ocsp.trustwave.com/06"
		$req20 = "http://ocsp.vikingcloud.com/0:"
		$req21 = "http://ocsp.vikingcloud.com/0A"
		$req22 = "http://www.indigorose.com 0"
		$req23 = "https://certs.securetrust.com/CA05"
		$req24 = "https://certs.securetrust.com/CA0:"
		$req25 = "https://certs.securetrust.com/CA0<"
		$req26 = "https://secure.comodo.net/CPS0C"
		$req27 = "https://ssl.trustwave.com/CA03"
		$req28 = "www.lua.org"
